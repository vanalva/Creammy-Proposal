...
window.ProposalConfig = {
  ...
  "shakefront-full": {
    ...
    "includes": [
      ...
      "Desarrollo en Webflow: 10+ paginas con diseno pixel-perfect",
      ...
      "Sistema de reservas y agenda integrado"
    ],
    "deliverables": [
  ...
  "shakefront-lite": {
    ...
    "includes": [
      "Diseno UI/UX responsive (desktop, tablet, movil, horizontal)",
      "Desarrollo en Webflow: one-pager con 10+ secciones",
      "SEO avanzado",
      "Hosting, dominio, SSL y correos corporativos",
  ...
  client: {
  "name": "Azorica Voyages",
  "contactName": "Paula",
  "tagline": "expediciones auténticas en el corazón del Atlántico",
  "accentColor": "#f0ff3d"
},
  paymentText: "70% al inicio · 20% entrega branding · 10% entrega final",
  bankInfo: {
  "bank": "BBVA",
